...
- Пользователь может открыть `/group-chats`, увидеть список group/supergroup чатов, редактировать title и управлять участниками через существующие profiles.
...
- Дальнейшее развитие group chat: роли, администраторы и service messages поверх уже существующих `chats/chat_members`.
